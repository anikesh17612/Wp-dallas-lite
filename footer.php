					...
					<?php $enable_copyright_text = get_theme_mod('enable_copyright_text', '1');
						if ($enable_copyright_text){ ?>
							<div class="wp-copyright col-md-6">
								...
								<?php echo get_theme_mod('copyright_text', 'Copyright &copy; 2018 Dallas Lite <sup>Lite</sup>. All Right Reserved. Created by <a href="'.$main_url.'" target="_blank">JoomDev</a>'); ?>
							</div><!-- site-info -->
							<?php
						}else{
							} ?>
