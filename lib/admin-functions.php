...
function social_share_facebook_checkbox()
	{
?>
        <input type="checkbox" name="social-share-facebook" value="1" <?php
	checked(1, get_option('social-share-facebook') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_twitter_checkbox()
	{
?>
        <input type="checkbox" name="social-share-twitter" value="1" <?php
	checked(1, get_option('social-share-twitter') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_linkedin_checkbox()
	{
?>
        <input type="checkbox" name="social-share-linkedin" value="1" <?php
	checked(1, get_option('social-share-linkedin') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_reddit_checkbox()
	{
?>
        <input type="checkbox" name="social-share-reddit" value="1" <?php
	checked(1, get_option('social-share-reddit') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_email_checkbox()
	{
?>
        <input type="checkbox" name="social-share-email" value="1" <?php
	checked(1, get_option('social-share-email') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_google_plus_checkbox()
	{
?>
        <input type="checkbox" name="social-share-google-plus" value="1" <?php
	checked(1, get_option('social-share-google-plus') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_pinterest_checkbox()
	{
?>
        <input type="checkbox" name="social-share-pinterest" value="1" <?php
	checked(1, get_option('social-share-pinterest') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_delicious_checkbox()
	{
?>
        <input type="checkbox" name="social-share-delicious" value="1" <?php
	checked(1, get_option('social-share-delicious') , true); ?> /> Check for Yes
   <?php
	}
...
function social_share_stumbleupon_checkbox()
	{
?>
        <input type="checkbox" name="social-share-stumbleupon" value="1" <?php
	checked(1, get_option('social-share-stumbleupon') , true); ?> /> Check for Yes
   <?php
	}
...
function add_social_share_icons($content)
	...
	if (get_option("social-share-twitter") == 1)
		{
		$html = $html . "<div class='twitter'><a target='_blank' href='" . esc_html_e($twitterURL) . "' ><i class='fa fa-twitter' aria-hidden='true'></i></a></div>";
		}
